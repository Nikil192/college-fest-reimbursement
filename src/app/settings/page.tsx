      ...
      <div className="space-y-6">
        ...
        <div className="bg-[var(--card-bg)] border border-[var(--card-border)] rounded-xl p-4 sm:p-6 shadow-sm">
          <div className="flex flex-col items-start gap-4 sm:flex-row">
            ...
            <div className="min-w-0 flex-1">
              <h2 className="text-lg font-semibold mb-1">WhatsApp CLI (wacli) Integration</h2>
              ...
              <div className="space-y-3 bg-gray-50 dark:bg-gray-800/40 p-4 rounded-lg border border-[var(--card-border)]">
                ...
                <div className="flex flex-col gap-2 text-sm sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <span className="break-all font-mono text-xs">wacli send text --to ...</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-[var(--card-bg)] border border-[var(--card-border)] rounded-xl p-4 sm:p-6 shadow-sm">
          <div className="flex flex-col items-start gap-4 sm:flex-row">
            ...
            <div className="min-w-0 flex-1">
              <h2 className="text-lg font-semibold mb-1">Local Document Storage</h2>
              <p className="text-sm text-gray-500 mb-4">
              ...
              <div className="space-y-3 bg-gray-50 dark:bg-gray-800/40 p-4 rounded-lg border border-[var(--card-border)]">
                <div className="flex flex-col gap-2 text-sm sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <span className="break-all font-mono text-xs text-blue-600">storage/documents</span>
                </div>
                <div className="flex flex-col gap-2 text-sm sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="bg-[var(--card-bg)] border border-[var(--card-border)] rounded-xl p-4 sm:p-6 shadow-sm">
          <div className="flex flex-col items-start gap-4 sm:flex-row">
            ...
            <div className="min-w-0 flex-1">
              <h2 className="text-lg font-semibold mb-1">Role-Based Access Control (RBAC)</h2>
              <p className="text-sm text-gray-500 mb-4">
